...
public class Register extends javax.swing.JPanel {
    ...
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerBtnActionPerformed
        ...
        if (sqlite.checkUserExists(username) == false && password.equals(confpass) == true && sqlite.checkPasswordStrength(password) == true && username.isEmpty() == false && password.isEmpty() == false && confpass.isEmpty() == false) {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Username already exists!", "Register Failed", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
        else if(!password.equals(confpass)){
            javax.swing.JOptionPane.showMessageDialog(this, "Passwords do not match!", "Register Failed", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
        else if(!sqlite.checkPasswordStrength(password)){
            javax.swing.JOptionPane.showMessageDialog(this, "Password is not strong enough!\nIt must be at least 8 characters long and contain at least one uppercase letter, one lowercase letter, one digit, and one special character.", "Register Failed", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
        else{
            javax.swing.JOptionPane.showMessageDialog(this, "Empty inputs", "Register Failed", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
